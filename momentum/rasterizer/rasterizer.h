...
//        map; for more details see nimble/common/Utility/SkinnedMesh.h.  If textureTriangles is not
//        provided, the regular triangles array will be used in its place.
...
// For backwards-compatibility with existing Nimble code; takes the positions/normals/triangles as
// vectors of Eigen::Vector3f.
void rasterizeMesh(
    gsl::span<const Eigen::Vector3f> positions_world,
