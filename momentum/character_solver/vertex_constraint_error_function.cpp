...
template class VertexConstraintErrorFunctionT<float, VertexPositionDataT<float>, 3>;
template class VertexConstraintErrorFunctionT<double, VertexPositionDataT<double>, 3>;

template class VertexConstraintErrorFunctionT<float, VertexNormalDataT<float>, 1>;
template class VertexConstraintErrorFunctionT<double, VertexNormalDataT<double>, 1>;

template class VertexConstraintErrorFunctionT<float, VertexPlaneDataT<float>, 1>;
template class VertexConstraintErrorFunctionT<double, VertexPlaneDataT<double>, 1>;
