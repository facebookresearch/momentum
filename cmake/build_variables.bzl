...
math_test_sources = [
    ...
    "test/math/support_polygon_test.cpp",
...
character_solver_public_headers = [
    ...
    "character_solver/camera_vertex_projection_error_function.h",
    "character_solver/center_of_mass_error_function.h",
    ...
    "character_solver/plane_collision_query.h",
    ...
    "character_solver/support_contacts.h",
    "character_solver/transform_pose.h",
    "character_solver/trust_region_qr.h",
    "character_solver/vertex_error_function.h",
    "character_solver/vertex_normal_error_function.h",
    "character_solver/vertex_plane_error_function.h",
    "character_solver/vertex_position_error_function.h",
...
character_solver_sources = [
    ...
    "character_solver/camera_vertex_projection_error_function.cpp",
    "character_solver/center_of_mass_error_function.cpp",
    ...
    "character_solver/error_function_types.cpp",
    "character_solver/fixed_axis_error_function.cpp",
    "character_solver/floor_error_function.cpp",
    ...
    "character_solver/joint_to_joint_orientation_error_function.cpp",
    ...
    "character_solver/plane_collision_query.cpp",
    ...
    "character_solver/support_contacts.cpp",
    "character_solver/transform_pose.cpp",
    "character_solver/trust_region_qr.cpp",
    "character_solver/vertex_error_function.cpp",
    "character_solver/vertex_normal_error_function.cpp",
    "character_solver/vertex_plane_error_function.cpp",
    "character_solver/vertex_position_error_function.cpp",
...
character_solver_test_sources = [
    ...
    "test/character_solver/camera_vertex_projection_error_function_test.cpp",
    ...
    "test/character_solver/floor_error_function_test.cpp",
    ...
    "test/character_solver/support_contacts_test.cpp",
...
character_sequence_solver_public_headers = [
    ...
    "character_sequence_solver/joint_to_joint_sequence_error_function.h",
    ...
    "character_sequence_solver/sdf_collision_sequence_error_function.h",
...
character_sequence_solver_sources = [
    ...
    "character_sequence_solver/joint_to_joint_sequence_error_function.cpp",
    ...
    "character_sequence_solver/sdf_collision_sequence_error_function.cpp",
...
glove_utils_test_sources = [
    "test/marker_tracking/glove_utils_test.cpp",
]
